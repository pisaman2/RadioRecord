...
#Change These
RSSFile = '/var/www/html/rss2/JakeYapp.xml'
RSSFeedTitle = 'Sunday Breakfast with Jake Yapp'
RSSFeedDescription = 'Sunday Breakfast with Jake Yapp Podcasts RSS Feed - WAN Version'
FilePath = '/var/www/html/Radio/JakeYapp/'
FileType = '*.mp3'
RSSImage = 'http://is5.mzstatic.com/image/thumb/Music71/v4/c7/ef/57/c7ef5745-3915-c0ae-e39c-6f39f6e8c490/source/1200x630bb.jpg'
FileDirWeb = 'http://sammarkham.club/Radio/JakeYapp/'
...
for item in FileLocations:
    ...
    GUID = '\n  <GUID>http://sammarkham.club/Radio/JakeYapp/%s</GUID>' % FileName
    Description = '\n  <description>Jake Yapp Podcast: %s</description>\n\n' % FileName
